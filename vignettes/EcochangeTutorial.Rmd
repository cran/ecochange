...
## Installation
Users can install the package and the dependencies running <span style="font-family:courier; font-size:1.1em;">install.packages()</span>. They can load it using either <span style="font-family:courier; font-size:1.1em;">require()</span> or <span style="font-family:courier; font-size:1.1em;">library()</span>. Users must be sure that all dependencies are correctly installed.
